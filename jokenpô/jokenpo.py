    ...
    if(escolha == 1):
        ...
        while gameover1 != 4:
            ...
            if (jogada1 == 0 and jogada2 == 2) or (jogada1 == 2 and jogada2 == 1) or (jogada1 == 1 and jogada2 == 0):
                ...
                vitoria2 = vitoria2 + 1
            elif (jogada1 == jogada2 and (jogada1 and jogada2 in {0,1,2})):
                print("Empatou!")
                empate = empate + 1
            elif (jogada1 or jogada2 != {0,1,2}):
...
#Jogador X Computador---------------------------------------------------------------------------------------------------
        ...
        while gameover2 != 4:
            ...
            elif (jogada1 == computador and (jogada1 and computador in {0,1,2})):
                print("Empatou!")
                print("O computador jogou:",computador)
                empate = empate + 1
            elif (jogada1 or computador != {0,1,2}):
                print("Comando inválido. Insira um número entre 0 e 2.\n")
#---sair do jogo-------------------------------------------------------------------------------------------------------
            sair = int(input("Se deseja sair do modo de jogo, digite 4. Caso contrário, digite 1: \n"))
            while sair != 4 and sair != 1:
